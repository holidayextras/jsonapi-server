[![Coverage Status](https://coveralls.io/repos/holidayextras/jsonapi-server/badge.svg?branch=master&foo=bar)](https://coveralls.io/r/holidayextras/jsonapi-server?branch=master)
