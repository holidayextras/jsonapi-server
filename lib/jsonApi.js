...
jsonApi.setConfig = apiConfig => {
  ...
  jsonApi._apiConfig.doNotEnforcePagination = jsonApi._apiConfig.doNotEnforcePagination == true
  
  responseHelper.setBaseUrl(jsonApi._apiConfig.pathPrefix)
  responseHelper.setMetadata(jsonApi._apiConfig.meta)
  responseHelper.setValidateOutput(!jsonApi._apiConfig.doNotValidateOuput)
