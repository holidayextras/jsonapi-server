...
swaggerPaths._addBasicPaths = function(paths, resourceName, resourceConfig) {
  ...
  paths["/" + resourceName] = {};
  if (!resourceConfig.swagger || !resourceConfig.swagger.all || resourceConfig.swagger.all.indexOf('find') !== -1) {
    paths["/" + resourceName].get = swaggerPaths._getPathOperationObject({
      handler: "search",
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger.all || resourceConfig.swagger.all.indexOf('create') !== -1) {
    paths["/" + resourceName].post = swaggerPaths._getPathOperationObject({
      handler: "create",
      resourceName: resourceName,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger.one || resourceConfig.swagger.one.indexOf('find') !== -1) {
    paths["/" + resourceName + "/{id}"].get = swaggerPaths._getPathOperationObject({
      handler: "find",
      resourceName: resourceName,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger.one || resourceConfig.swagger.one.indexOf('delete') !== -1) {
    paths["/" + resourceName + "/{id}"].delete = swaggerPaths._getPathOperationObject({
      handler: "delete",
      resourceName: resourceName,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger.one || resourceConfig.swagger.one.indexOf('update') !== -1) {
     paths["/" + resourceName + "/{id}"].patch = swaggerPaths._getPathOperationObject({
      handler: "update",
      resourceName: resourceName,
...
swaggerPaths._addDeepPaths = function(paths, resourceName, resourceConfig, relationName, relation) {
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger[relationName] || resourceConfig.swagger[relationName].indexOf('find') !== -1) {
    paths["/" + resourceName + "/{id}/" + relationName].get = swaggerPaths._getPathOperationObject({
      handler: "find",
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger[relationName] || resourceConfig.swagger[relationName].indexOf('find') !== -1) {
    paths["/" + resourceName + "/{id}/relationships/" + relationName].get = swaggerPaths._getPathOperationObject({
      handler: "find",
      resourceName: relation,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger[relationName] || resourceConfig.swagger[relationName].indexOf('create') !== -1) {
    paths["/" + resourceName + "/{id}/relationships/" + relationName].post = swaggerPaths._getPathOperationObject({
      handler: "create",
      resourceName: relation,
      relationType: relationType,
      extraTags: resourceName,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger[relationName] || resourceConfig.swagger[relationName].indexOf('update') !== -1) {
    paths["/" + resourceName + "/{id}/relationships/" + relationName].patch = swaggerPaths._getPathOperationObject({
      handler: "update",
      resourceName: relation,
      relationType: relationType,
      extraTags: resourceName,
  ...
  if (!resourceConfig.swagger || !resourceConfig.swagger[relationName] || resourceConfig.swagger[relationName].indexOf('delete') !== -1) {
    paths["/" + resourceName + "/{id}/relationships/" + relationName].delete = swaggerPaths._getPathOperationObject({
      handler: "delete",
      resourceName: relation,
      relationType: relationType,
      extraTags: resourceName,
