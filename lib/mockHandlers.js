 ...
 */
memoryStore.handlers.search = function(request, callback) {
 ...
 */
memoryStore.handlers.find = function(request, callback) {
 ...
 */
memoryStore.handlers.create = function(request, newResource, callback) {
 ...
 */
memoryStore.handlers.delete = function(request, callback) {
  // Find the requested resource
  memoryStore.handlers.find(request, function(err, theResource) {
 ...
 */
memoryStore.handlers.update = function(request, partialResource, callback) {
  // Find the requested resource
  memoryStore.handlers.find(request, function(err, theResource) {
    if (err) return callback(err);
